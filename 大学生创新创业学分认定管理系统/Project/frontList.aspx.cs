...
using System.Data;
public partial class Project_frontList : System.Web.UI.Page
{
    ...
    protected void LBEnd_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Redirect("frontList.aspx?title=" + title.Text.Trim() + "&&projectDate=" + projectDate.Text.Trim() + "&&userObj=" + userObj.SelectedValue.Trim()+ "&&addTime=" + addTime.Text.Trim() + "&&affirmStateObj=" + affirmStateObj.SelectedValue.Trim()+ "&&affirmUserName=" + affirmUserName.Text.Trim()+ "&&shzt=" + shzt.Text.Trim());
        }
