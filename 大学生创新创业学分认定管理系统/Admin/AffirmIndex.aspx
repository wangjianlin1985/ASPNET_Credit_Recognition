<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AffirmIndex.aspx.cs" Inherits="WebSystem.Admin.AdminIndex" %>
...
<frameset rows="50,*,20"  frameborder="no" frameborder="1" framespacing="0">
  ...
  <frameset cols="184,*"   id="frame">
	<frame src="Affirm_Left.aspx" name="leftFrame" noresize="noresize" marginwidth="0" marginheight="0" frameborder="1" scrolling="no" target="lefts" />
