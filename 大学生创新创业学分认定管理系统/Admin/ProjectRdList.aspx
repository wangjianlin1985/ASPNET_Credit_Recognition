<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectRdList.aspx.cs" Inherits="chengxusheji.Admin.ProjectList" %>
    ...
    <asp:Repeater ID="RpProject" runat="server" onitemcommand="RpProject_ItemCommand">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><a href="ProjectRdEdit.aspx?projectId=<%#Eval("projectId") %>"><img src="Images/MillMes_ICO.gif" alt="修改信息..." /></a><asp:ImageButton class="DelClass" ID="IBDelClass" runat="server" CommandArgument='<%#Eval("projectId")%>' CommandName="Del" ImageUrl="Images/Delete.gif"  ToolTip="删除该信息..."/></td>
             </tr>
        </ItemTemplate>
