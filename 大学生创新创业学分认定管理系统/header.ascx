...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.aspx" class="navbar-brand">学分认定系统</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>Affirm/frontlist.aspx">认定者</a></li>
                <li><a href="<%=basePath %>AffirmState/frontlist.aspx">认定状态</a></li>-->
                <li><a href="<%=basePath %>ProjectType/frontlist.aspx">项目类型查询</a></li>
                <li><a href="<%=basePath %>Project/frontlist.aspx">创新创业项目</a></li>
                <li><a href="<%=basePath %>CreditTran/frontlist.aspx">学分转换记录</a></li>
                
                <li><a href="<%=basePath %>Leaveword/frontlist.aspx">留言交流</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>Project/frontUserAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;申请创业创新学分</a></li>
                        <li><a href="<%=basePath %>Project/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我申请的创业创新学分</a></li>
                        <li><a href="<%=basePath %>CreditTran/userFrontAdd.aspx"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;申请学分转换</a></li>
                        <li><a href="<%=basePath %>CreditTran/userFrontlist.aspx"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我申请的学分转换</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontAdd.aspx"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我要留言</a></li>
